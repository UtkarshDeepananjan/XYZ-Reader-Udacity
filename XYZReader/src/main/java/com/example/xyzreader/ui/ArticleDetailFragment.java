    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            bodyView.setText(Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY)
                    ...
                    .replaceAll("(\r\n\r\n|\n\n)", "<br /><br />")));
            if (mCursor.getString(ArticleLoader.Query.PHOTO_URL) != null) {
                Picasso.get().load(mCursor.getString(ArticleLoader.Query.PHOTO_URL)).into(mPhotoView);
                Bitmap bitmap = ((BitmapDrawable) mPhotoView.getDrawable()).getBitmap();
                Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
                    public void onGenerated(Palette palette) {
                        int darkMutedColor = palette.getDarkMutedColor(ContextCompat.getColor(getActivity().getApplicationContext(), R.color.theme_accent));
